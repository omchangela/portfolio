...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://formspree.io/f/manwwyln`, {
        method: "POST",
        body: formData,
        headers: {
    ...
    <section id="contact" className="my-[10%] overflow-hidden" aria-label="contact me">
      ...
      <div ref={contactSection} className="mt-10 flex flex-col gap-20 md:grid md:grid-cols-6 md:px-12">
        <div className="col-span-4">
          ...
          >
            I am currently available for freelance work and accepting new projects. Let's collaborate!
          </p>

          {/* Form Section */}
          <form name="contact" autoComplete="off" onSubmit={handleSubmit} className="mt-10 font-grotesk">
            ...
            {formStatus === "success" && (
              <p className="mt-4 text-green-500">Thanks! The form was submitted successfully.</p>
            )}
            {formStatus === "error" && (
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a href="mailto:changelaom@gmail.com" className="group relative w-fit cursor-pointer" target="_blank" rel="noreferrer">
                <span>changelaom@gmail.com</span>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              <a href="https://github.com/omchangela" className="group flex items-center space-x-2" target="_blank" rel="noreferrer">
              ...
              <a href="https://www.linkedin.com/in/om-changela1545" className="group flex w-fit items-center space-x-2" target="_blank" rel="noreferrer">
              ...
              <a
                href="https://www.instagram.com/om_changela_"
